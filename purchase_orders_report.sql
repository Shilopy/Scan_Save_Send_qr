...
SELECT
    ...
    po.[Rail Ship Date] AS "Rail_Ship_Date",
    po.[Carrier name] AS "Carrier_name",
    ...
    ISNULL(
        STUFF((
            ...
            WHERE pp.[Purchasing document] = po.[Purchasing document]
              AND pp.[Purchasing date] = po.[Document date]
              AND pp.[Posted] = 1
